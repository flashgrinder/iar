                ...
                <div class="footer__column footer__column--two">
                    ...
                    <address class="footer__address">
                        ...
                        <div class="footer__mail footer__info text text--normal text--dark-gray text--w-thin">
                            ...
                            <span class="footer__text-address">Москва, Бережковская набережная, д. 20, стр. 9</span>
                        </div>
                    </address>
                </div>
            </div>
            ...
            <a href="https://fcdigital.ru" class="devsite__link">
                ...
                <div class="devsite__logo">
                    <svg class="devsite__logo-img" width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M22.5011 21.5088V44.0319L10.9922 32.7703L20.3166 23.6463L22.5011 21.5088Z" fill="#202020"/>
                        <path d="M27.791 38.8534V5.17578L44.9998 22.0146L27.791 38.8534Z" fill="#202020"/>
                        <path d="M22.5014 0V15.2512L7.79316 29.6403L0 22.0147L20.3169 2.13755L22.5014 0Z" fill="#202020"/>
                    </svg>
                </div>
            </a>
        </div>
